...
from ..nequip.radial_basis import BesselBasis
...
class NormalizedBasis(torch.nn.Module):
    ...
    def __init__(
        ...
        original_basis_kwargs: dict = {},  # noqa
        n: int = 4000,
        ...
        with torch.no_grad():
            ...
            if norm_basis_mean_shift:
                ...
                basis_mean = torch.as_tensor(0.0, device=basis_std.device, dtype=basis_std.dtype)
